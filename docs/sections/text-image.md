...
Matches Figma `10989:45023` and `10989:45024`. Available under Brand storytelling, and as a Content block in 2 column. This is an open composition on the page canvas, unlike Split Image-Text's enclosed panel. Desktop uses two equal columns within 1200px, separated by 60px (32px when embedded). Below 900px it stacks in DOM order: Image left places the image before text; Image right places it after text. Reading, keyboard and visual order agree.
