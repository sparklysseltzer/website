...
All collection pages use a white (`#FFFFFF`) document background, independent of brand context. Explicit section backgrounds remain configurable; this rule controls the page canvas and gaps.
